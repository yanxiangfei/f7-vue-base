      ...
      <f7-view id="left-panel-view" navbar-through :dynamic-navbar="true">
        ...
        <f7-pages>
          <f7-page>
            ...
            <f7-list>
              <f7-list-item link="/hello/" title="hello"></f7-list-item>
      ...
      <f7-view id="right-panel-view" navbar-through :dynamic-navbar="true">
        ...
        <f7-pages>
          <f7-page>
            ...
            <f7-block-title>Load page in main view</f7-block-title>
            <f7-list>
              <f7-list-item link="/hello/" title="hello" link-view="#main-view" link-close-panel></f7-list-item>
              <f7-list-item link="/form/" title="Form" link-view="#main-view" link-close-panel></f7-list-item>
            </f7-list>
          </f7-page>
        </f7-pages>
        ...
        <f7-pages>
          <f7-page>
            ...
            <f7-list>
              ...
              <f7-list-item link="/test2/" title="test2"></f7-list-item>
            </f7-list>
      ...
      <f7-view navbar-fixed>
        <f7-pages>
          <f7-page>
            ...
            <f7-block inner>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Neque, architecto. Cupiditate laudantium rem nesciunt numquam, ipsam. Voluptates omnis, a inventore atque ratione aliquam. Omnis iusto nemo quos ullam obcaecati, quod.</f7-block>
          </f7-page>
        </f7-pages>
      </f7-view>
    </f7-popup>
      ...
      <f7-view>
        <f7-pages>
          <f7-page login-screen>
            <f7-login-screen-title>Login2</f7-login-screen-title>
            <f7-list form>
              <f7-list-item>
            ...
            <f7-list>
              ...
              <f7-list-label>
                <p>Click Sign In to close Login Screen2</p>
              </f7-list-label>
            </f7-list>
          </f7-page>
        </f7-pages>
...
<f7-picker-modal id="Picker">
  <f7-block>
    <f7-label>dscfs</f7-label>
  </f7-block>
</f7-picker-modal>
